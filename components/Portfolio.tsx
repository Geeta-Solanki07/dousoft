...
import { portfolios } from "@/data/landingData"; // Make sure your portfolio data (title, image, category, metrics) is exported from landingData.ts
          ...
          <div className="space-y-10 md:space-y-16 md:mt-[240px] lg:mt-[260px]">
            ...
            <div className="bg-[#22C55E] rounded-[2.5rem] p-8 md:p-12 text-white shadow-xl min-h-[420px] flex flex-col justify-center relative group">
              <div className="relative z-10 text-center">
                ...
                <button className="mt-10 bg-white text-gray-900 font-bold px-8 py-4 rounded-full shadow-lg hover:scale-105 transition-transform flex items-center justify-center gap-3 mx-auto">
  ...
  return (
    <div className="bg-white rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden group border border-gray-50">
      ...
      <div className="p-8 md:p-10">
        ...
        {metrics && (
          <div className="flex flex-wrap gap-8 mt-8 border-t border-gray-50 pt-8">
