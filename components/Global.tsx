...
export default function GlobalPresence() {
  return (
    <section className="w-full bg-[#F0F8F0] flex justify-center py-16 lg:py-24">
      ...
      <div className="w-full max-w-[1318px] min-h-[729px] px-5 flex flex-col justify-between">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          {/* LEFT TEXT AREA */}
          <div className="flex flex-col gap-5 max-w-[338px]">
            ...
            >
              ...
              <span className="text-[#0B6F1E] font-medium text-sm md:text-[18px]">
                Global Presence
              </span>
            </div>

            {/* HEADING */}
            <h2 className="text-[20px] md:text-[26px] font-normal text-[#3A3A3A]">
              We Serve 5+ Countries
            </h2>

            {/* DESCRIPTION */}
            <p className="text-[#3A3A3A] text-sm md:text-[18px] font-medium">
          ...
          <div className="flex flex-col gap-4">
            ...
            {countries.map((country, i) => (
              <div key={i} className="flex items-center gap-5">
                ...
                <div className="relative w-[60px] h-[32px] border rounded-sm overflow-hidden">
                  <Image
                    src={country.flag}
                    alt={country.name}
                    fill
                ...
                <span className="text-[18px] md:text-[22px] text-[#3A3A3A]">
                  {country.name}
                </span>
        ...
        {/* MAP SECTION */}
        <div className="relative w-full h-[200px] md:h-[367px] mt-16">
          ...
          <div className="absolute left-[69%] top-[55%]">
            ...
            <div className="w-3 h-3 bg-[#0B6F1E] rounded-full animate-ping absolute"></div>
            <div className="w-3 h-3 bg-[#0B6F1E] rounded-full relative"></div>
